...
const Topmenu = () => {
    ...
    return (
        <nav className=" flex tablet:relative w-[1100px] phone:w-[80vw] laptop:w-[57vw] z-[100] items-center tablet:h-[8vh] tablet:w-[85vw] laptop:h-[7vh] justify-between laptop:px-[1vw] laptop:py-[2vw] px-[10px] py-[20px] ">
            ...
            {/* For responsive */}
            <div className={` hidden ${isShow ? "translate-x-0" : "translate-x-[-120%]"} transition tablet:flex left-0  z-[100] absolute top-0 h-[99vh] w-[90vw] backdrop-blur-[5px] `}>
            ...
            <div className=" flex phone:hidden gap-[20px] justify-between tablet:hidden ">
            ...
            <form className=" flex items-center ">
                <img src={Search} className=" relative phone:hidden laptop:left-[1.8vw] laptop:w-[1vw]  tablet:hidden left-[35px] " alt="Search" />


                <img onClick={() => setSearch(true)} src={Search} className=" tablet:block tablet:left-[30vw] hidden relative phone:block phone:w-[4vw] phone:left-[22vw] " alt="Search" />
                ...
                <div className={` z-[100] hidden tablet:block tablet:h-[90vh] tablet:w-[89vw] transition duration-500 phone:block ${search ? "scale-[1]" : "scale-0"} absolute p-[5vw] left-0 top-0 w-[100%] h-[90vh] bg-white `}>
                    <button type="button" onClick={() => setSearch(false)} className=" fas tablet:text-[3vw] fa-arrow-left " />
                    <div className=" flex items-center ">
                        <input placeholder="Search foods" className=" px-[4vw] w-[100%] tablet:h-[8vw] tablet:rounded-[1vw] tablet:text-[2.5vw] rounded-[2vw] mt-[2vw] font-semibold text-[3vw] outline-none h-[10vw] bg-[#F7F7F7] " type="text" />
                        <button className=" bg-[#6832dc] text-[4vw] w-[10vw] text-[white] rounded-[1vw] tablet:h-[8vw] h-[10vw] fas fa-magnifying-glass " />
                    </div>
                </div>
