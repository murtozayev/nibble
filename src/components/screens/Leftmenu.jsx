...
const Leftmenu = () => {
    return (
        <div className=" w-[304px] phone:w-[15vw] h-[1059px] phone:items-center phone:rounded-[2vw] phone:h-[90vh] tablet:h-[100vh] tablet:w-[12vw] justify-between phone:py-[5vw] flex flex-col laptop:h-[100vh] bg-[#F7F7F7] rounded-r-[20px] p-[10px] py-[40px] ">
            <div>
